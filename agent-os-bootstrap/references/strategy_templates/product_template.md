...
[POPULATE: Single product or platform with multiple products?]

**Multi-Product Model (if applicable):**

| Product | Primary User | North Star | Strategic Role |
|---------|--------------|------------|-----------------|
| [PRODUCT_1] | [USER_TYPE] | [METRIC] | [e.g., "Land", "Expand", "Defend"] |
| [PRODUCT_2] | [USER_TYPE] | [METRIC] | [e.g., "Land", "Expand", "Defend"] |

## User Journey & Value Moments

[POPULATE: What is the user's first "aha" moment? When do they see ROI?]

| Stage | User Needs | Product Response | Success Signal |
|-------|-----------|-----------------|-----------------|
| Activation | [NEED] | [FEATURE/EXPERIENCE] | [METRIC] |
| Growth | [NEED] | [FEATURE/EXPERIENCE] | [METRIC] |
| Retention | [NEED] | [FEATURE/EXPERIENCE] | [METRIC] |

## Product Principles

[POPULATE: What are the non-negotiable design/product principles? E.g., "Mobile-first", "Privacy by default", "Offline-capable"]
...
- [ ] North star metric grows ≥X% YoY
- [ ] User onboarding time-to-activation ≤ [THRESHOLD]
- [ ] Feature adoption within 6 months ≥X% of eligible users
- [ ] Customer effort score and friction points below benchmark

## Current State Assessment

[POPULATE: How close is the product to the vision? What are the biggest gaps? What is working?]

## Regulatory/Compliance Anchors

[POPULATE if applicable:]
- Data privacy by product (GDPR, CCPA, HIPAA if relevant)
- Accessibility standards (WCAG, ADA)
- Security baseline for feature launch
- Third-party audit requirements (SOC2, etc.)
